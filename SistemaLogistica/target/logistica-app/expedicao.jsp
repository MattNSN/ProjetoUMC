...
<%
    request.setAttribute("pageTitle", "Expedição - LOG - Soluções rápidas");
%>
<jsp:include page="includes/header.jsp" />

<jsp:include page="includes/sidebar.jsp">
    <jsp:param name="page" value="expedicao" />
</jsp:include>
...
<div class="main-content">
    <div class="page-header">
        ...
        <div class="page-header-title">
            <h1>Expedição de Mercadorias</h1>
            <p>Gerenciamento e histórico de expedições</p>
        </div>
    </div>
    
    <div class="log-card mb-4">
        <form action="listarExpedicoes" method="GET">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-4">
                    <label class="form-label">Buscar Pedido ou Destino</label>
    ...
    <div class="mb-3 d-flex justify-content-between align-items-center">
        <h2 class="text-log-gray">Expedições Registradas</h2>
        <a href="${pageContext.request.contextPath}/formulario-checklist.jsp" class="btn btn-log-primary">
            <i class="bi bi-plus-circle"></i> Nova Expedição
        </a>
    </div>
    ...
    <div class="row g-3">
        <c:choose>
            <c:when test="${empty checklists}">
                <div class="col-12">
                    <div class="log-card">
                        <p class="text-log-gray-muted mb-0">Nenhuma expedição registrada encontrada.</p>
                    </div>
                </div>
            </c:when>
            <c:otherwise>
                ...
                <c:forEach var="checklist" items="${checklists}">
                    <div class="col-12 col-lg-6">
                        <div class="log-card">
                            ...
                            <%-- Cabeçalho Ajustado: Remetente em destaque, NF/DI abaixo --%>
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div>
                                    ...
                                    <p class="text-log-gray-muted" style="font-size: 0.875rem;">
                                        ...
                                        <%-- Mostra a data de expedição direta --%>
                                        <fmt:formatDate value="${checklist.expedicaoDataHora}" pattern="dd/MM/yyyy HH:mm"/>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="border-top border-log-accent pt-3">
                                <div class="row g-2 mb-2">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <p class="text-log-gray mb-0">${checklist.expedicaoTransportadora}</p>
                                    </div>
                                    <div class="col-6">
                                        <small class="text-log-gray-muted">Motorista:</small>
                                        <p class="text-log-gray mb-0">${checklist.expedicaoMotorista}</p>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3 d-flex gap-2">
                                    ...
                                    <a href="excluirChecklist?id=${checklist.id}&origem=expedicao" 
